public class RainWaterTrapping {
	...
	public static void main(String[] args) {
		...
		int[] rightMaxHeight = new int[towerHeights.length];//This array used to store right side maximum height respective to every building

		int maxHeightTillNow = 0;

		//THe right most building don't have any building right after that,we are taking right most building height as his right max height.
